...
var subdomainGatewaySpec = &GatewaySpec{
	Paths:         defaultPaths,
	UseSubdomains: true,
}

var defaultKnownGateways = map[string]*GatewaySpec{
...
type HostnameKey string

var GatewayHostnameKey HostnameKey = "gw-hostname"
...
func prepareKnownGateways(publicGateways map[string]*GatewaySpec) gatewayHosts {
	var hosts gatewayHosts

	hosts.exact = make(map[string]*GatewaySpec, len(publicGateways)+len(defaultKnownGateways))
...
func isKnownHostname(hostname string, knownGateways gatewayHosts) (gw *GatewaySpec, ok bool) {
...
func knownSubdomainDetails(hostname string, knownGateways gatewayHosts) (gw *GatewaySpec, gwHostname, ns, rootID string, ok bool) {
